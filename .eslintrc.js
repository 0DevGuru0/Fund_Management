...
module.exports = {
  ...
  plugins: ['prefer-arrow', 'unicorn', 'import', 'jsdoc', 'prettier', '@next/next'],
  extends: [
    'eslint:recommended',
  ...
  overrides: [
    {
      ...
      parserOptions: {
        ...
        project: ['./apc/tsconfig.json', './devops/tsconfig.json'],
    ...
    {
      files: ['**/src/application/components/**/*.stories.tsx'],
      rules: {
        'max-lines': 'off',
      },
    },
